...
CRISES_POOL = {
    "초기": [
        {"id": 13, "title": "🍔 프랜차이즈 갑질 파동", "img": "https://images.unsplash.com/photo-1550547660-d9450f859349", "desc": "대형 본사의 갑질로 가맹점주가 사망하는 비극이 발생했습니다. '을의 눈물'에 공감한 국민들의 분노가 들끓고 있으며, 강력한 경제 민주화를 요구하는 목소리가 높습니다.", "options": [{"name": "규제 3법 통과", "cost": 0, "effect": [-20, 5, 10, 10], "detail": "대기업의 횡포를 막을 강력한 법안을 만듭니다. 을(乙)들은 환호하지만, 재계는 '기업 죽이기'라며 투자 축소를 경고합니다.", "reason": "자본가-20 (규제), 노동자+10 (보호)"}, {"name": "자율 상생 유도", "cost": 0, "effect": [10, -5, -10, -5], "detail": "기업의 자정에 맡기기로 했습니다. 시장 자유는 지켰으나, 국민들은 '기업 봐주기'라며 정부가 로비에 넘어갔다고 의심합니다.", "reason": "자본가+10 (자유), 노동자-10 (실망)"}, {"name": "긴급 대출 지원", "cost": -15, "effect": [-5, 5, 0, 10], "detail": "피해 입은 자영업자에게 돈을 빌려줍니다. 당장 폐업은 막았지만 근본적인 구조는 그대로이며, 가계 부채만 늘리는 꼴이 되었습니다.", "reason": "빈곤층+10 (생존), 국고-15 (지출)"}]},
        {"id": 14, "title": "📉 코인 거래소 먹튀", "img": "https://images.unsplash.com/photo-1621504450168-38f647319936", "desc": "국내 1위 코인 거래소가 먹튀 파산했습니다. 2030 세대의 자산이 증발하고 자살 시도가 잇따르며 사회적 혼란이 가중되고 있습니다.", "options": [{"name": "투자자 손실 보전", "cost": -25, "effect": [-10, -10, 15, -5], "detail": "세금으로 피해를 보전해줍니다. 청년 파산은 막았으나, '도박 빚을 갚아주냐'는 성실 납세자들의 분노가 폭발했습니다.", "reason": "노동자+15 (구제), 중산층-10 (분노)"}, {"name": "책임 원칙", "cost": 0, "effect": [5, 5, -20, -10], "detail": "투기 수요에 경종을 울렸습니다. 하지만 전 재산을 잃은 청년층이 대거 신용불량자로 전락하며 사회적 활력이 급격히 떨어집니다.", "reason": "중산층+5 (원칙), 노동자-20 (파산)"}, {"name": "가상자산 규제 강화", "cost": -5, "effect": [-5, 0, -5, 0], "detail": "뒤늦게 규제 장벽을 세웠습니다. 시장은 건전해졌지만, '소 잃고 외양간 고치기'라는 비판과 함께 블록체인 산업 위축을 가져왔습니다.", "reason": "자본가-5 (규제), 노동자-5 (뒷북)"}]},
        {"id": 3, "title": "🤖 AI 일자리 습격", "img": "https://images.unsplash.com/photo-1485827404703-89b55fcc595e", "desc": "생성형 AI의 발전으로 사무직과 단순 노무직의 대량 해고가 시작되었습니다. '기계가 인간을 대체한다'는 공포가 사회를 덮쳤습니다.", "options": [{"name": "로봇세 도입 (기본소득)", "cost": -15, "effect": [-20, 5, 10, 10], "detail": "기업에 세금을 물려 실직자에게 현금을 지급합니다. 노동자들은 안도하지만, 기업들은 '혁신을 가로막는 규제 감옥'이라며 반발합니다.", "reason": "자본가-20 (규제), 노동자+10 (안전망)"}, {"name": "AI 규제 철폐 (성장)", "cost": +10, "effect": [20, 5, -15, -15], "detail": "AI 강국으로 도약하며 국가 경쟁력은 폭등합니다. 하지만 구조조정 당한 수만 명의 노동자들이 거리로 나앉아 빈곤층으로 전락합니다.", "reason": "자본가+20 (주가폭등), 노동자-15 (해고)"}, {"name": "공공 근로 확대", "cost": -20, "effect": [-5, -5, 5, 10], "detail": "정부가 세금으로 단기 일자리를 급조해 급한 불은 껐습니다. 하지만 '세금 낭비', '질 낮은 일자리'라는 비판을 받습니다.", "reason": "빈곤층+10 (생계), 국고-20 (비용)"}]},
        {"id": 12, "title": "🧬 신약 부작용 사태", "img": "https://images.unsplash.com/photo-1532187863486-abf9dbad1b69", "desc": "국가 지원 신약에서 치명적인 부작용이 발견되었습니다. 피해자들의 소송과 정부 책임론이 대두되며 바이오 산업이 흔들립니다.", "options": [{"name": "허가 취소 및 배상", "cost": -20, "effect": [-10, 5, 5, 5], "detail": "국민 안전을 선택해 신뢰를 회복했습니다. 하지만 바이오 산업 투자가 위축되고, 관련 기업 주가 폭락으로 개미 투자자들이 울상입니다.", "reason": "중산층+5 (신뢰), 자본가-10 (주가하락)"}, {"name": "인과관계 규명 우선", "cost": 0, "effect": [10, -10, -10, -5], "detail": "산업 보호를 위해 시간을 끌었습니다. 기업은 안도하지만, 피해자들은 '기업 편들기'라며 울분을 토하고 정부의 생명 경시 풍조가 비판받습니다.", "reason": "자본가+10 (보호), 중산층-10 (비판)"}, {"name": "공공 의료 강화", "cost": -30, "effect": [-15, 5, 10, 15], "detail": "민간 주도 개발의 한계를 인정하고 공공 의료를 확충했습니다. 의료 서비스 질은 올랐으나, 막대한 세금이 투입되어 고소득층 저항이 심합니다.", "reason": "빈곤층+15 (혜택), 자본가-15 (세금)"}]}
    ],
    "중기": [
        {"id": 7, "title": "🏘️ 부동산 시장 대폭락", "img": "https://images.unsplash.com/photo-1560518883-ce09059eeffa", "desc": "금리 인상 여파로 집값이 30% 이상 급락했습니다. 깡통 전세 피해자가 속출하고 건설사 부도 위기가 감돕니다.", "options": [{"name": "부양책 (규제 완화)", "cost": -10, "effect": [15, 5, -10, -10], "detail": "다주택자 감세와 대출 완화로 집값 방어에 성공해 자산가들은 안도합니다. 하지만 '부자만 살려준다'는 비판 속에 무주택 서민의 꿈은 멀어집니다.", "reason": "자본가+15 (자산방어), 노동자-10 (박탈감)"}, {"name": "시장 자율 (방관)", "cost": 0, "effect": [-20, -20, 10, 5], "detail": "거품이 꺼지며 무주택자들은 환호합니다. 하지만 자산이 증발한 상위층과 중산층의 소비가 얼어붙어 실물 경기가 깊은 침체에 빠집니다.", "reason": "자본가-20 (폭락), 노동자+10 (내집마련)"}, {"name": "전세 사기 피해 구제", "cost": -20, "effect": [-5, -5, 10, 15], "detail": "세금으로 피해 보증금을 지원해 서민들의 눈물을 닦아주었습니다. 하지만 성실 상환자들과의 형평성 논란이 일며 납세자들의 불만이 커집니다.", "reason": "빈곤층+15 (구제), 국고-20 (세금)"}]},
        {"id": 9, "title": "⚡ 에너지 위기", "img": "https://images.unsplash.com/photo-1565514020125-998dc57774dc", "desc": "중동 전쟁으로 유가가 배럴당 150불을 넘었습니다. 난방비 폭탄에 서민들은 떨고 있고, 한전 적자는 감당 불가입니다.", "options": [{"name": "요금 현실화 (인상)", "cost": +10, "effect": [0, -10, -15, -20], "detail": "공기업 부실은 막았고 국가 신용도도 지켰습니다. 하지만 관리비 고지서를 받은 국민들의 분노가 하늘을 찌르고, 취약계층은 냉골에서 잡니다.", "reason": "국고+10 (건전성), 빈곤층-20 (생존위협)"}, {"name": "요금 동결 (적자 보전)", "cost": -30, "effect": [-5, 10, 10, 10], "detail": "세금으로 요금 인상을 막아 국민 부담은 줄였습니다. 하지만 국가 부채가 급증했고, 에너지 과소비는 여전해 미봉책이라는 비판을 받습니다.", "reason": "빈곤층+10 (안도), 국고-30 (부채)"}, {"name": "바우처 선별 지급", "cost": -10, "effect": [0, -5, -5, 15], "detail": "취약계층에게만 난방비를 지원했습니다. 지원을 못 받은 중산층과 서민들은 '나도 힘든데 왜 안 주냐'며 상대적 박탈감을 호소합니다.", "reason": "빈곤층+15 (생존), 노동자-5 (박탈감)"}]},
        {"id": 4, "title": "⚔️ 무역 보복 조치", "img": "https://images.unsplash.com/photo-1595246737293-27d096162332", "desc": "외교 갈등으로 주요 교역국이 핵심 소재 수출을 금지했습니다. 공장 가동이 멈추고 수출길이 막힐 위기입니다.", "options": [{"name": "굴욕적 협상 (실리)", "cost": 0, "effect": [10, 5, 5, -5], "detail": "상대국의 요구를 들어주고 수출길을 엽니다. 경제는 살렸으나, '국격을 팔아먹었다'는 국민적 비난과 자존심의 상처는 깊습니다.", "reason": "자본가+10 (매출회복), 빈곤층-5 (자존심)"}, {"name": "강경 대응 (맞불)", "cost": -10, "effect": [-15, -10, -10, -5], "detail": "자주 국가의 자존심은 지킵니다. 하지만 무역 전쟁이 장기화되면서 물가가 폭등하고 기업 실적이 악화되어 전 국민이 고통받습니다.", "reason": "자본가-15 (매출급감), 중산층-10 (물가)"}, {"name": "소재 국산화 R&D", "cost": -30, "effect": [-5, -5, 5, 0], "detail": "장기적인 기술 독립을 선언합니다. 방향은 옳지만, 당장의 성과가 나오기까지 막대한 예산 출혈과 경기 침체를 감내해야 합니다.", "reason": "노동자+5 (일자리), 국고-30 (지출)"}]},
        {"id": 5, "title": "🏭 기후 재난", "img": "https://images.unsplash.com/photo-1579766922979-4d6cb600259d", "desc": "숨을 쉴 수 없는 미세먼지와 기록적인 폭우가 동시에 덮쳤습니다. 반지하 거주민이 고립되고 농작물 가격이 폭등합니다.", "options": [{"name": "탄소세 도입", "cost": +5, "effect": [-15, -5, 5, 10], "detail": "강력한 규제로 환경은 개선되었고 세수도 늘었습니다. 하지만 비용 부담이 커진 기업들이 고용을 줄였고, 물가 상승으로 중산층의 삶이 팍팍해졌습니다.", "reason": "자본가-15 (비용), 빈곤층+10 (안전)"}, {"name": "경제 우선", "cost": 0, "effect": [15, 5, -10, -20], "detail": "공장을 풀가동해 경제 지표는 방어했습니다. 그러나 기후 재난의 피해는 고스란히 취약계층에게 집중되어, 빈민가의 주거 환경이 파괴되었습니다.", "reason": "자본가+15 (이익), 빈곤층-20 (침수피해)"}, {"name": "피해 복구 지원금", "cost": -20, "effect": [-5, 0, 0, 10], "detail": "피해 입은 국민에게 현금을 지급해 원성을 달랬습니다. 하지만 근본적인 원인은 해결되지 않아 매년 같은 재난이 반복될 것이며 재정만 축납니다.", "reason": "빈곤층+10 (구제), 국고-20 (지출)"}]},
        {"id": 6, "title": "📉 합계출산율 0.5명", "img": "https://images.unsplash.com/photo-1519689680058-324335c77eba", "desc": "국가 소멸 위기론이 대두되었습니다. 국민연금 고갈 공포가 확산되며 세대 간 갈등이 폭발 직전입니다.", "options": [{"name": "현금 지원 확대", "cost": -30, "effect": [-5, 10, 5, -5], "detail": "아이 낳는 가정에 파격적인 돈을 주어 중산층은 환호합니다. 하지만 재원 마련을 위해 노인 복지 예산을 깎으면서 취약계층 노인들은 생존 위기입니다.", "reason": "중산층+10 (양육비), 빈곤층-5 (복지축소)"}, {"name": "이민청 설립", "cost": -5, "effect": [10, -10, -10, 5], "detail": "노동력 부족을 외국인으로 채워 기업은 안도합니다. 하지만 일자리 경쟁이 치열해진 노동자와 문화적 충돌을 우려하는 중산층의 반발이 거셉니다.", "reason": "자본가+10 (인력), 노동자-10 (경쟁)"}, {"name": "연금 개혁", "cost": +10, "effect": [-5, -15, -15, -5], "detail": "재정 시한폭탄은 제거했습니다. 그러나 당장 월급에서 더 많은 돈이 떼이는 직장인들의 분노가 투표 심판으로 이어질 기세입니다.", "reason": "중산층-15 (보험료), 국고+10 (재정)"}]}
    ],
    "말기": [
