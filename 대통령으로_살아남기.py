...
CRISES_POOL = {
    "초기": [
        {
            "id": 13, "title": "🍔 프랜차이즈 갑질 파동", 
            "img": "https://images.unsplash.com/photo-1550547660-d9450f859349?q=80&w=800", 
            "desc": "대형 본사의 갑질로 가맹점주가 사망했습니다. 을의 눈물에 국민들이 분노합니다.", 
            "options": [
                {"name": "규제 3법 통과", "cost": 0, "effect": [-20, 5, 10, 10], "detail": "강력 규제. 재계 반발.", "reason": "자본가-20, 노동자+10"}, 
                {"name": "자율 상생 유도", "cost": 0, "effect": [10, -5, -10, -5], "detail": "기업 자율. 봐주기 논란.", "reason": "자본가+10, 노동자-10"}, 
                {"name": "긴급 대출 지원", "cost": -15, "effect": [-5, 5, 0, 10], "detail": "폐업 방지. 가계부채 증가.", "reason": "빈곤층+10, 국고-15"}
            ]
        },
        {
            "id": 14, "title": "📉 코인 거래소 먹튀", 
            "img": "https://images.unsplash.com/photo-1621504450168-38f647319936?q=80&w=800", 
            "desc": "거래소 파산으로 2030 세대 자산이 증발했습니다.", 
            "options": [
                {"name": "손실 보전", "cost": -25, "effect": [-10, -10, 15, -5], "detail": "세금 투입. 납세자 분노.", "reason": "노동자+15, 중산층-10"}, 
                {"name": "책임 원칙", "cost": 0, "effect": [5, 5, -20, -10], "detail": "투기 경종. 청년 파산.", "reason": "중산층+5, 노동자-20"}, 
                {"name": "규제 강화", "cost": -5, "effect": [-5, 0, -5, 0], "detail": "뒤늦은 규제. 산업 위축.", "reason": "자본가-5, 노동자-5"}
            ]
        },
        {
            "id": 3, "title": "🤖 AI 일자리 습격", 
            "img": "https://images.unsplash.com/photo-1485827404703-89b55fcc595e?q=80&w=800", 
            "desc": "AI가 인간 업무를 대체하며 고용 불안이 확산됩니다.", 
            "options": [
                {"name": "로봇세 도입", "cost": -15, "effect": [-20, 5, 10, 10], "detail": "기업 증세.", "reason": "자본가-20, 노동자+10"}, 
                {"name": "규제 철폐", "cost": +10, "effect": [20, 5, -15, -15], "detail": "AI 강국 도약.", "reason": "자본가+20, 노동자-15"}, 
                {"name": "공공 근로", "cost": -20, "effect": [-5, -5, 5, 10], "detail": "단기 일자리.", "reason": "빈곤층+10, 국고-20"}
            ]
        },
        {
            "id": 12, "title": "🧬 신약 부작용 사태", 
            "img": "https://images.unsplash.com/photo-1532187863486-abf9dbad1b69?q=80&w=800", 
            "desc": "국가 지원 신약의 부작용이 발견되었습니다.", 
            "options": [
                {"name": "허가 취소", "cost": -20, "effect": [-10, 5, 5, 5], "detail": "안전 우선. 산업 위축.", "reason": "중산층+5, 자본가-10"}, 
                {"name": "인과 규명 우선", "cost": 0, "effect": [10, -10, -10, -5], "detail": "산업 보호. 여론 악화.", "reason": "자본가+10, 중산층-10"}, 
                {"name": "공공 의료 강화", "cost": -30, "effect": [-15, 5, 10, 15], "detail": "공공성 확충. 세금 투입.", "reason": "빈곤층+15, 자본가-15"}
            ]
        }
    ],
    "중기": [
        {
            "id": 7, "title": "🏘️ 부동산 시장 대폭락", 
            "img": "https://images.unsplash.com/photo-1560518883-ce09059eeffa?q=80&w=800", 
            "desc": "집값 급락으로 깡통 전세와 건설사 부도가 속출합니다.", 
            "options": [
                {"name": "부양책", "cost": -10, "effect": [15, 5, -10, -10], "detail": "규제 완화.", "reason": "자본가+15, 노동자-10"}, 
                {"name": "시장 자율", "cost": 0, "effect": [-20, -20, 10, 5], "detail": "거품 붕괴 용인.", "reason": "자본가-20, 노동자+10"}, 
                {"name": "피해 구제", "cost": -20, "effect": [-5, -5, 10, 15], "detail": "세금 지원.", "reason": "빈곤층+15, 국고-20"}
            ]
        },
        {
            "id": 9, "title": "⚡ 에너지 위기", 
            "img": "https://images.unsplash.com/photo-1565514020125-998dc57774dc?q=80&w=800", 
            "desc": "유가 폭등으로 난방비 대란이 일어났습니다.", 
            "options": [
                {"name": "요금 인상", "cost": +10, "effect": [0, -10, -15, -20], "detail": "적자 해소.", "reason": "국고+10, 빈곤층-20"}, 
                {"name": "요금 동결", "cost": -30, "effect": [-5, 10, 10, 10], "detail": "재정 부담.", "reason": "빈곤층+10, 국고-30"}, 
                {"name": "바우처 지급", "cost": -10, "effect": [0, -5, -5, 15], "detail": "선별 지원.", "reason": "빈곤층+15, 노동자-5"}
            ]
        },
        {
            "id": 4, "title": "⚔️ 무역 보복 조치", 
            "img": "https://images.unsplash.com/photo-1595246737293-27d096162332?q=80&w=800", 
            "desc": "핵심 소재 수출 금지로 공장이 멈췄습니다.", 
            "options": [
                {"name": "굴욕적 협상", "cost": 0, "effect": [10, 5, 5, -5], "detail": "실리 추구.", "reason": "자본가+10, 빈곤층-5"}, 
                {"name": "강경 대응", "cost": -10, "effect": [-15, -10, -10, -5], "detail": "자존심.", "reason": "자본가-15, 중산층-10"}, 
                {"name": "국산화 R&D", "cost": -30, "effect": [-5, -5, 5, 0], "detail": "장기 투자.", "reason": "노동자+5, 국고-30"}
            ]
        },
        {
            "id": 5, "title": "🏭 기후 재난", 
            "img": "https://images.unsplash.com/photo-1579766922979-4d6cb600259d?q=80&w=800", 
            "desc": "기록적인 폭우와 미세먼지가 덮쳤습니다.", 
            "options": [
                {"name": "탄소세 도입", "cost": +5, "effect": [-15, -5, 5, 10], "detail": "환경 개선.", "reason": "자본가-15, 빈곤층+10"}, 
                {"name": "경제 우선", "cost": 0, "effect": [15, 5, -10, -20], "detail": "규제 완화.", "reason": "자본가+15, 빈곤층-20"}, 
                {"name": "피해 복구금", "cost": -20, "effect": [-5, 0, 0, 10], "detail": "현금 지급.", "reason": "빈곤층+10, 국고-20"}
            ]
        },
        {
            "id": 6, "title": "📉 합계출산율 0.5명", 
            "img": "https://images.unsplash.com/photo-1519689680058-324335c77eba?q=80&w=800", 
            "desc": "국가 소멸 위기론이 대두되었습니다.", 
            "options": [
                {"name": "현금 지원", "cost": -30, "effect": [-5, 10, 5, -5], "detail": "양육비 확대.", "reason": "중산층+10, 빈곤층-5"}, 
                {"name": "이민청 설립", "cost": -5, "effect": [10, -10, -10, 5], "detail": "노동력 수입.", "reason": "자본가+10, 노동자-10"}, 
                {"name": "연금 개혁", "cost": +10, "effect": [-5, -15, -15, -5], "detail": "고통 분담.", "reason": "중산층-15, 국고+10"}
            ]
        }
    ],
    "말기": [
        {
            ...
            "desc": "환율 1,500원 돌파. 국가 부도 위기설.", 
            "options": [
                {"name": "법인세 인하", "cost": -10, "effect": [15, 5, -10, -15], "detail": "낙수효과.", "reason": "자본가+15, 빈곤층-15"}, 
                {"name": "재난지원금", "cost": -30, "effect": [-15, 5, 10, 20], "detail": "내수 방어.", "reason": "빈곤층+20, 자본가-15"}, 
                {"name": "고금리 긴축", "cost": +10, "effect": [5, -20, -10, -5], "detail": "물가 안정.", "reason": "자본가+5, 중산층-20"}
            ]
        },
        {
            "id": 2, "title": "📢 광화문 100만 촛불", 
            "img": "https://images.unsplash.com/photo-1563986768609-322da13575f3?q=80&w=800", 
            "desc": "정권 퇴진을 요구하는 100만 인파가 집결했습니다.", 
            "options": [
                {"name": "증세 및 복지", "cost": +20, "effect": [-25, -5, 10, 20], "detail": "요구 수용.", "reason": "빈곤층+20, 자본가-25"}, 
                {"name": "공권력 투입", "cost": -5, "effect": [15, 5, -20, -15], "detail": "강제 진압.", "reason": "자본가+15, 노동자-20"}, 
                {"name": "대국민 사과", "cost": 0, "effect": [-10, 5, 5, 5], "detail": "내각 사퇴.", "reason": "자본가-10, 중산층+5"}
            ]
        },
        {
            "id": 10, "title": "💣 북한 국지적 도발", 
            "img": "https://images.unsplash.com/photo-1554223249-1755a5b512c8?q=80&w=800", 
            "desc": "휴전선 포격 도발. 전쟁 위기 고조.", 
            "options": [
                {"name": "강력 응징", "cost": -20, "effect": [5, -5, -5, -5], "detail": "원점 타격.", "reason": "자본가+5, 중산층-5"}, 
                {"name": "대화 시도", "cost": 0, "effect": [-15, 5, 5, 5], "detail": "확전 방지.", "reason": "자본가-15, 빈곤층+5"}, 
                {"name": "국방비 증액", "cost": -30, "effect": [-5, -10, -15, -5], "detail": "군비 강화.", "reason": "노동자-15, 국고-30"}
            ]
        },
        {
            "id": 8, "title": "🕵️ 권력형 비리 게이트", 
            "img": "https://images.unsplash.com/photo-1589829545856-d10d557cf95f?q=80&w=800", 
            "desc": "측근 비리 발각으로 도덕성에 치명타.", 
            "options": [
                {"name": "성역 없는 수사", "cost": 0, "effect": [-15, 10, 10, 0], "detail": "읍참마속.", "reason": "중산층+10, 자본가-15"}, 
                {"name": "정치 탄압 주장", "cost": 0, "effect": [5, -20, -20, -5], "detail": "지지층 결집.", "reason": "자본가+5, 중산층-20"}, 
                {"name": "제도 개혁 약속", "cost": -10, "effect": [-5, 5, 5, 0], "detail": "시선 분산.", "reason": "중산층+5, 자본가-5"}
            ]
        },
        {
            "id": 1, "title": "🦠 치명적 신종 바이러스", 
            "img": "https://images.unsplash.com/photo-1584036561566-baf8f5f1b144?q=80&w=800", 
            "desc": "전염병 확산으로 의료 체계 붕괴.", 
            "options": [
                {"name": "국가 봉쇄", "cost": -10, "effect": [-5, -10, -15, 5], "detail": "경제 마비.", "reason": "빈곤층+5, 노동자-15"}, 
                {"name": "위드 코로나", "cost": 0, "effect": [10, 5, 0, -25], "detail": "경제 우선.", "reason": "자본가+10, 빈곤층-25"}, 
                {"name": "치료제 무상", "cost": -40, "effect": [-5, 5, 5, 15], "detail": "재정 투입.", "reason": "빈곤층+15, 국고-40"}
            ]
        }
    ]
}
