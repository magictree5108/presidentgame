...
ARCH_DESC = {
    ...
    **💰 [자본가/기업주]**
    ...
    "중산층": """
    **🏠 [화이트칼라/전문직/유주택자]**
    - **핵심 가치:** 자산 방어, 공정성, 세금 효율
    - **혐오:** 부동산 가격 하락, 과도한 세금, 불공정 채용
    - **특징:** 여론을 주도하는 핵심 계층입니다. '내 돈이 허투루 쓰이는 것'을 가장 싫어합니다.
    """,
    "노동자": """
    **👷 [블루칼라/임금생활자/중소기업]**
    - **핵심 가치:** 고용 안정, 임금 인상, 노동권
    - **혐오:** 쉬운 해고, 물가 폭등, 외국인 노동자 유입
    - **특징:** 경제 위기의 직격탄을 맞습니다. 생계가 위협받으면 가장 먼저 거리로 나옵니다.
    """,
    "빈곤층": """
    **🙏 [기초수급자/노인/구직단념자]**
